...
export class ProposalComponent implements OnInit {
  ...
  constructor(private activeRoute: ActivatedRoute, private _postService: ProposalService, private _porp: ProposalService, private _jop: JopServiceService, private builder: FormBuilder) {
