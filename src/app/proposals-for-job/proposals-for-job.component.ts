...
export class ProposalsForJobComponent implements OnInit {
  constructor(private proSer: ProfileService, private proposalsService: ProposalsService, private activeRoute: ActivatedRoute, private route: Router, private hireService: HireFreelancerService, private authservice: AuthService) { }
  /*  currentuser:any;
   gettokenID(): string {
